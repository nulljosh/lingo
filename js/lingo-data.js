...
questions.precalc11 = [
    ...
    { type: 'mathChoice', question: 'Quadratic formula?', answer: 'x = (-b±√(b²-4ac))/2a', choices: ['x = (-b±√(b²-4ac))/2a', 'x = -b/2a', 'x = ±√(b²-4ac)', 'x = -b±√(b²+4ac)/2a'] },
...
categories.math.subjects.push(
    { id: 'precalc11', name: 'Pre-Calculus 11', icon: '📘', level: 'BC Grade 11' },
    { id: 'precalc12', name: 'Pre-Calculus 12', icon: '📙', level: 'BC Grade 12' }
);

categories.science.subjects.push(
    { id: 'anatomy12', name: 'Anatomy & Physiology', icon: '🫀', level: 'BC Grade 12' }
);
